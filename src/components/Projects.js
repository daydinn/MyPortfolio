...
const projects = [
  ...
  },
  {
    ...
    description:
      "eShop is my first Java application, designed to simulate an online shopping platform. The app includes functionalities for managing articles and a shopping cart, along with features for generating invoices. The implemented components include the ability to create articles, clear the shopping cart, generate invoices, manage customers and employees, log in and out, sort articles by number or description, update the quantity of items in the cart, purchase articles, and maintain a changelog for tracking updates. Additionally, items and their stock levels, as well as their properties, are read from and written to a text file, which also serves as a log. These completed features provide a solid foundation for a fully functional e-commerce platform and represent a significant learning project in Java development. ",
    images: [
      eshop1,
      eshop2,
      eshop3,
